...
def add_character():
  ...
  if nights != 2:
    ...
    first_night_order_pos = transform_character_name(input("What character do they go after in first night order: "))
  if nights != 1:
    other_night_description = input("New Character Other Night Description: ")
    other_night_order_pos = transform_character_name(input("What character do they go after in other night order: "))
  ...
  if first_night_order_pos != "":
    ...
    night_file["first_night_characters"].insert(spot_to_add_character+1, name.lower())
  ...
  if other_night_order_pos != "":
    ...
    other_night_addition = [{ "name" : name.title() }, 
                            ...
                            { 'default_alignment' : first_night_alignment.title() },
                            { "order_pos": night_x_characters.index(name.lower()) + 1 }]
    ...
    night_file["other_night_characters"].insert(spot_to_add_character+1, name.lower())
